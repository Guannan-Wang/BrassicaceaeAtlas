...
for num in list(range(2000, 16000, 2000)):
	try:
		...
		scarches_scanvi_annotator("AthCsa.h5ad", ref_key = "orig.ident", ref_value = ["AthCsa_AthCR1", "AthCsa_AthCR2"], labels_key = "cCellType", model_affix = "scANVI" + str(num) + "HVGs", batch_key = "orig.ident", hvg_num = num)
		print("-" * 100)
